...
const ReactParticles= () => {
    ...
    const options = useMemo(
        () => ({
            background: {
                color: {
                    value: "#1d1d1d",  // Background color of the particles canvas (blue shade)
                },
            },
            ...
            particles: {
                color: {
                    value: "#ffd600",  // Color of the particles (white)
                },
                links: {
                    color: "#ffd600",  // Color of the links connecting particles (white)
